if ( Ti.Platform.getOsname() != "android" ){
	...
	var foodWin = Ti.UI.createWindow({
		title:L('Food', 'Lebensmittel')
	});
	foodWin.add(foodListView);
	
	// init medicine list
	// var MedicineListView = require('ui/common/MedicineListView');
	// var medicineListView = new MedicineListView();
	// var medicineWin = Ti.UI.createWindow({
		// title:L('Medicine', 'Medikamente')
	// });
	// medicineWin.add(medicineListView);
