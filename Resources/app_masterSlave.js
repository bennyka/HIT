...
(function() {
  ...
  console.log(isTablet);
   ...
   var Window;
   if (isTablet) {
     Window = require('ui/tablet/ListWindow');
   } else {
     // iPhone and Mobile Web make use of the platform-specific navigation controller,
     // all other platforms follow a similar UI pattern
     if (osname === 'iphone') {
       Window = require('ui/handheld/ios/ListWindow');
     } else if (osname == 'mobileweb') {
       Window = require('ui/handheld/mobileweb/ListWindow');
     } else {
       Window = require('ui/handheld/android/ListWindow');
     }
   }
   new Window().open();
})();
